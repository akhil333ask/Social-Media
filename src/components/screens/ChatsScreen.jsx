import { Plus, Bookmark, Radio, Users } from 'lucide-react';
...
export default function ChatsScreen() {
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <div className="px-4 py-3 space-y-2 border-b border-dark-card">
        <div className="bg-dark-card rounded-xl px-4 py-3 flex items-center gap-3">
          <Bookmark className="text-white" size={20} />
          <span className="text-white font-medium">Saved Messages</span>
        </div>

        <div className="bg-dark-card rounded-xl px-4 py-3 flex items-center gap-3">
          <Radio className="text-white" size={20} />
          <span className="text-white font-medium">My Church Channel</span>
        </div>

        <div className="bg-dark-card rounded-xl px-4 py-3 flex items-center gap-3">
          <Users className="text-white" size={20} />
          <span className="text-white font-medium">My Church Group Chat</span>
        </div>
      </div>
      ...
      <div className="px-4 py-2">
        {chats.map((chat, index) => (
          <div
            key={index}
            className="flex items-center gap-3 py-3 border-b border-dark-card last:border-0"
          >
